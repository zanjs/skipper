...
@section('page_header')
    <div class="page-title">
        <i class="skipper-data"></i> @if(isset($dataType->id)){{ 'Edit BREAD for ' . $dataType->name . ' table' }}@elseif(isset($table)){{ 'Create BREAD for ' . $table . ' table' }}@endif
    </div>
@stop
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form role="form"
                      action="@if(isset($dataType->id)){{ route('skipper.database.edit_bread', $dataType->id) }}@else{{ route('skipper.database.store_bread') }}@endif"
                      method="POST">
                        ...
                        <table id="users" class="table table-hover">
                            ...
                            @foreach($tableData as $data)
                                @if(isset($dataType->id))
                                    <?php $dataRow = Anla\Skipper\Models\DataRow::where('data_type_id', '=',
