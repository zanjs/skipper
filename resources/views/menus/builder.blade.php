...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ config('skipper.assets_path') }}/css/nestable.css">
@stop

@section('page_header')
    <h1 class="page-title">
        <i class="skipper-list"></i>Menu Builder ({{ $menu->name }})
        <div class="btn btn-success add_item"><i class="skipper-plus"></i> New Menu Item</div>
    </h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="skipper-trash"></i> Are you sure you want to delete this menu
                        item?</h4>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('skipper.dashboard') }}/menu/delete_menu_item" id="delete_form"
                          method="POST">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="skipper-plus"></i> Create a New Menu Item</h4>
                </div>
                <form action="{{ route('skipper.menu.add_item') }}" id="delete_form" method="POST">
                    <div class="modal-body">
                        ...
                        <label for="icon_class">Font Icon class for the Menu Item (Use a <a
                                    href="{{ config('skipper.assets_path') . '/fonts/skipper/icons-reference.html' }}"
                                    target="_blank">Skipper Font Class</a>)</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="skipper-edit"></i> Edit Menu Item</h4>
                </div>
                <form action="{{ route('skipper.menu.update_menu_item') }}" id="edit_form" method="POST">
                    <div class="modal-body">
                        <label for="name">Title of the Menu Item</label>
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ config('skipper.assets_path') }}/js/jquery.nestable.js"></script>
    <script>
        $(document).ready(function () {
            ...
            $('.dd').on('change', function (e) {
                ...
                $.post('{{ route('skipper.menu.order_item') }}', {
