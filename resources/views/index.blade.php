...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ config('skipper.assets_path') }}/css/ga-embed.css">
@stop

@section('content')
    <div class="page-content">
        <div class="widgets">
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new Anla\Skipper\Models\User())->getTable())) { ?>
            <div class="panel widget center bgimage" style="background-image:url({{ config('skipper.assets_path') }}/images/widget-backgrounds/02.png);">
            ...
            <?php } ?>
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new Anla\Skipper\Models\Post())->getTable())) { ?>
            <div class="panel widget center bgimage" style="background-image:url({{ config('skipper.assets_path') }}/images/widget-backgrounds/03.png);">
                <div class="dimmer"></div>
                <div class="panel-content">
            ...
            <?php } ?>
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new Anla\Skipper\Models\Page())->getTable())) { ?>
            <div class="panel widget center bgimage" style="background-image:url({{ config('skipper.assets_path') }}/images/widget-backgrounds/04.png);">
                <div class="dimmer"></div>
                <div class="panel-content">
        ...
        <div style="padding:15px;">
            <?php $google_analytics_client_id = Skipper::setting("google_analytics_client_id"); ?>
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        <script src="{{ config('skipper.assets_path') }}/js/ga-embed/chart.min.js"></script>
        <script src="{{ config('skipper.assets_path') }}/js/ga-embed/moment.min.js"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="{{ config('skipper.assets_path') }}/js/ga-embed/view-selector2.js"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="{{ config('skipper.assets_path') }}/js/ga-embed/date-range-selector.js"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="{{ config('skipper.assets_path') }}/js/ga-embed/active-users.js"></script>
