...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'skipper:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Skipper.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/anla/skipper/src/Http/Controllers'));
        ...
        $this->info('Published Skipper controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/anla/skipper/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'Anla\\Skipper\\Http\\Controllers\\'.$class,
            $content
        );
