...
use Anla\Skipper\Http\Controllers\Traits\DatabaseUpdate;
use Anla\Skipper\Models\DataRow;
use Anla\Skipper\Models\DataType;

class SkipperDatabaseController extends Controller
{
    ...
    {
        return view('skipper::tools.database.index');
    }

    public function create()
    {
        return view('skipper::tools.database.edit-add');
    }
    ...
    public function edit($table)
    {
        ...
        return view('skipper::tools.database.edit-add', compact('table', 'rows'));
    }
    ...
    public function addBread(Request $request)
    {
        ...
        return view('skipper::tools.database.edit-add-bread', $this->prepopulateBreadInfo($table));
    }
    ...
    public function storeBread(Request $request)
    {
        ...
        return redirect()->route('skipper.database')->with($data);
    }

    public function addEditBread($id)
    {
        return view(
            'skipper::tools.database.edit-add-bread', [
    ...
    {
        /** @var \Anla\Skipper\Models\DataType $dataType */
        $dataType = DataType::find($id);
