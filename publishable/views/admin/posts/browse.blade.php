...
@section('page_header')
    <h1 class="page-title">
        <i class="skipper-news"></i> {{ $dataType->display_name_plural }}
        <a href="{{ route($dataType->slug.'.create') }}" class="btn btn-success">
            <i class="skipper-plus"></i> Add New
        </a>
    </h1>
@stop
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <i class="skipper-trash"></i> Are you sure you want to delete this {{ $dataType->display_name_singular }}?
                    </h4>
                </div>
