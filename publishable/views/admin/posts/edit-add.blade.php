...
@section('content')
    <div class="page-content container-fluid">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="skipper-character"></i> Post Title
                ...
                <div class="col-md-4">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    @foreach(Anla\Skipper\Models\Category::all() as $category)
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <img src="{{ Skipper::image( $dataTypeContent->image ) }}" style="width:100%" />
                            @endif
        ...
        <form id="my_form" action="{{ route('skipper.upload') }}" target="form_target" method="post" enctype="multipart/form-data" style="width:0px;height:0;overflow:hidden">
            {{ csrf_field() }}
